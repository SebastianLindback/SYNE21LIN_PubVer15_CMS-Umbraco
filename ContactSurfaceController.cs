...
namespace CMS
{
    ...
    public class ContactSurfaceController : SurfaceController
    {
        ...
        [HttpGet]
        public IEnumerable<ContactDTO> GetContactDTOs()
        {
            ...
            var result = scope.Database.Fetch<ContactDTO>(query);
        ...
        // var result = scope.Database.Query<ContactDTO>("SELECT * FROM [umbraco].[dbo].[Contacts]");
        ...
        public IActionResult contactSubmit(ContactDTO contactForm)
        {
            ...
            {
                var data = new CMS.AddCommentsTable.Contactschema();
